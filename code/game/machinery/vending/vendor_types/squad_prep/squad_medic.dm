...
GLOBAL_LIST_INIT(cm_vending_clothing_medic, list(
		...
		list("Surgery Pouch", 0, /obj/item/storage/pouch/medical/surgery/full, (MARINE_CAN_BUY_R_POUCH|MARINE_CAN_BUY_L_POUCH), VENDOR_ITEM_REGULAR),
...
/obj/effect/essentials_set/medic
	spawned_gear_list = list(
		...
		/obj/item/roller,
		/obj/item/storage/pouch/medical/surgery/full,
	)
