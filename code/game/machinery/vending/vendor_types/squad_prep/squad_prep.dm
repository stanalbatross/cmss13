...
/obj/structure/machinery/cm_vending/clothing/marine
	...
	listed_products = list(
		...
		list("M276 Knife Rig (Full)", 0, /obj/item/storage/belt/knifepouch/full, MARINE_CAN_BUY_BELT, VENDOR_ITEM_REGULAR),
		...
		list("Bayonet Sheath (Full)", 0, /obj/item/storage/pouch/bayonet/full, (MARINE_CAN_BUY_R_POUCH|MARINE_CAN_BUY_L_POUCH), VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/populate_product_list(var/scale)
	listed_products = list(
		...
		list("M276 Knife Rig", 10, /obj/item/storage/belt/knifepouch, VENDOR_ITEM_REGULAR),
