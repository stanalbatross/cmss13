...
/obj/item/weapon/melee/throwing_knife
	...
	desc ="A military knife designed to be thrown at the enemy. Much quieter than a firearm, but requires a steady hand to be used effectively, in as much as you can use a throwing knife effectively against firearms and worse."
	flags_atom = FPRINT|CONDUCT
