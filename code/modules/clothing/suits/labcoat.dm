/obj/item/clothing/suit/storage/labcoat
	...
	var/buttoned = TRUE //they start zipped up

	verb/toggle()
		set name = "Toggle Suit Buttons" //maybe eventually someone will make a labcoat subtype for the button toggle
		set category = "Object" //though, it should probably just be in /obj/item/clothing/suit/ and have a var to say if it can toggle buttons or not
		set src in usr
		...
		if(src.buttoned == FALSE)
			src.icon_state = "[initial(icon_state)]" //if it's not buttoned it's set to the closed sprite
			src.buttoned = TRUE //and now it is buttoned
		else
			src.icon_state = "[initial(icon_state)]_open" //if it is buttoned it's set to the _open sprite
			src.buttoned = FALSE //this used to be a huge if icon_state chain of every single labcoat, what the fuck!
