...
/obj/item/clothing/head/gyrostabiliser
	name = "Gyro-stabiliser head rig"
	icon_state = "gyrostab0"
	item_state = "gyrostab0"
	desc = "An experimental set of gyroscopic cameras and motor stabilisers, calibrated to interface with a synthetic and fully motion-correct its camera feed, resulting in clear, consistent, unmoving vision 100% of the time even when subjected to intense physical forces."
