...
//======================================================
		...
		switch(href_list["simplemake"])
			...
			if(XENO_CASTE_LARVA)				transformed = M.change_mob_type( /mob/living/carbon/Xenomorph/Larva , null, null, delmob )
			if(XENO_CASTE_DEFENDER)			transformed = M.change_mob_type( /mob/living/carbon/Xenomorph/Defender, null, null, delmob )
			if(XENO_CASTE_WARRIOR)			transformed = M.change_mob_type( /mob/living/carbon/Xenomorph/Warrior, null, null, delmob )
			if(XENO_CASTE_RUNNER)			transformed = M.change_mob_type( /mob/living/carbon/Xenomorph/Runner , null, null, delmob )
			if(XENO_CASTE_DRONE)				transformed = M.change_mob_type( /mob/living/carbon/Xenomorph/Drone , null, null, delmob )
			if(XENO_CASTE_SENTINEL)			transformed = M.change_mob_type( /mob/living/carbon/Xenomorph/Sentinel , null, null, delmob )
			if("lurker")			transformed = M.change_mob_type( /mob/living/carbon/Xenomorph/Lurker , null, null, delmob )
			if(XENO_CASTE_CARRIER)			transformed = M.change_mob_type( /mob/living/carbon/Xenomorph/Carrier , null, null, delmob )
			if(XENO_CASTE_HIVELORD)			transformed = M.change_mob_type( /mob/living/carbon/Xenomorph/Hivelord , null, null, delmob )
			if(XENO_CASTE_PRAETORIAN)		transformed = M.change_mob_type( /mob/living/carbon/Xenomorph/Praetorian , null, null, delmob )
			if(XENO_CASTE_RAVAGER)			transformed = M.change_mob_type( /mob/living/carbon/Xenomorph/Ravager , null, null, delmob )
			if(XENO_CASTE_SPITTER)			transformed = M.change_mob_type( /mob/living/carbon/Xenomorph/Spitter , null, null, delmob )
			if(XENO_CASTE_BOILER)			transformed = M.change_mob_type( /mob/living/carbon/Xenomorph/Boiler , null, null, delmob )
			if(XENO_CASTE_BURROWER)			transformed = M.change_mob_type( /mob/living/carbon/Xenomorph/Burrower , null, null, delmob )
			if(XENO_CASTE_CRUSHER)			transformed = M.change_mob_type( /mob/living/carbon/Xenomorph/Crusher , null, null, delmob )
