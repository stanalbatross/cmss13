/datum/tech/human/droppod/item/combat_stimulants
...
/datum/tech/human/droppod/item/combat_stimulants/get_options(mob/living/carbon/human/H, obj/structure/droppod/D)
	. = ..()
