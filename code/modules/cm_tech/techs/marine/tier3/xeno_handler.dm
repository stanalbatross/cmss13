...
/datum/emergency_call/xeno_handler/spawn_items()
    ...
    if(istype(drop_spawn))
        new /obj/effect/alien/weeds/node(drop_spawn, null, null, hive_datum[XENO_HIVE_SUBMISSIVE]) //drop some weeds for xeno plasma regen.
...
/datum/emergency_call/xeno_handler/create_member(datum/mind/M)
    ...
    var/datum/hive_status/corrupted/submissive/hive = hive_datum[XENO_HIVE_SUBMISSIVE]
