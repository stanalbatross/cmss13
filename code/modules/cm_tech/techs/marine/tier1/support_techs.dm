/datum/tech/droppod/item/support_czsp
	name = "Support Combat Zone Support Package"
	desc = "Gives squad medics to use powerful tools to heal marines, and gives squad engineers a mod kit for their deployable."
