...
/obj/item/weapon/gun/flare
	...
	desc = "A flare gun issued to JTAC operators to use with standard flares. Cannot be used with signal flares. Comes with a miniscope. Flares fired from this gun will have their chemical composition ignited more efficiently, increasing brightness noticeably."
	icon_state = "m82f"
	item_state = "m82f"
