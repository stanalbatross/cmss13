...
/datum/entity/player/proc/statistic_load_human(var/list/datum/entity/statistic/S)
	if(!player_entity)
		return
	for(var/datum/entity/statistic/STAT in S)
		if(!LAZYISIN(player_entity.HS, STAT))
			STAT.sync()
			player_entity.HS.Insert(1, STAT)

/datum/entity/player/proc/statistic_load_xeno(var/list/datum/entity/statistic/S)
	if(!player_entity)
		return
	for(var/datum/entity/statistic/STAT in S)
...
/datum/entity/player/proc/statistic_load_caste(var/list/datum/entity/statistic/S)
	if(!player_entity)
		return
	for(var/datum/entity/statistic/STAT in S)
...
/datum/entity/player/proc/statistic_load_abilities(var/list/datum/entity/statistic/S)
	if(!player_entity)
		return
	for(var/datum/entity/statistic/STAT in S)
...
/datum/entity/player/proc/statistic_load_job(var/list/datum/entity/statistic/S)
	if(!player_entity)
		return
	for(var/datum/entity/statistic/STAT in S)
...
/datum/entity/player/proc/statistic_load_weapon(var/list/datum/entity/statistic/S)
	if(!player_entity)
		return
	for(var/datum/entity/statistic/STAT in S)
